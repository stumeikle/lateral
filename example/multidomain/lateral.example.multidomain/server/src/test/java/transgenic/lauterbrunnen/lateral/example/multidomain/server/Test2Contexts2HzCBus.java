...
/**
 * Created by stumeikle on 10/05/20.
 */
public class Test2Contexts2HzCBus {

    private static final Log LOG = LogFactory.getLog(Test2Contexts2HzCBus.class);
    private ProductAPI productAPI;
    private ShippingAPI shippingAPI;

    @Test
    public void Test2Contexts2HzCBus(){

        BasicConfigurator.configure();
        Lateral.INSTANCE.setPropertyFilename("test2contexts2hzcbus-app.properties");
