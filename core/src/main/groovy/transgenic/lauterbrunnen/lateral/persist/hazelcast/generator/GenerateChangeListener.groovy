...
class GenerateChangeListener extends GeneratePersister{
    ...
    public void generate(List<Class> protoclasses, Map<String, Field> idFields) {
        ...
        output << "import com.hazelcast.map.IMap;" << System.lineSeparator() +
...
//                "import transgenic.lauterbrunnen.lateral.admin.CommandHandler;"<< System.lineSeparator() +
        ...
        for (Class proto: protoclasses) {
            ...
            output << "        " << proto.getSimpleName() << "Persister " << lcentity << "Persister = inject(" << proto.getSimpleName() << "Persister.class, "+ diContext + "Context.class);" << System.lineSeparator +
