...
class GenerateRef extends GenerateImpl{
    ...
    public void generateRef(Class proto) {
        ...
        String contextImport="";
        if (!outputPackage.equals(classOutputPackage)) {
            contextImport="import " + outputPackage + "." + diContext + "Context;" + System.lineSeparator();
        }

        def fn = basePath + "/" + classOutputPackage.replaceAll("\\.","/") + "/" + proto.getSimpleName() + "Reference.java";
        println "Writing " + fn;
        ...
        output << ""<< System.lineSeparator();
        output << "import transgenic.lauterbrunnen.lateral.domain.AccessRestricted;" << System.lineSeparator()
